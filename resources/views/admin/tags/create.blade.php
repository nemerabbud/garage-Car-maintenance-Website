                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"
                              style="color: #e02222 !important;">{{__('cp.addTag')}}</span>
                    </div>
                </div>
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/tags')}}"
                                ...
                                @foreach($locales as $locale)
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="{{$locale->lang}}[name]" id="{{$locale->lang}}[name]" required

                                                         value="{{ old($locale->lang.'name') }}">
