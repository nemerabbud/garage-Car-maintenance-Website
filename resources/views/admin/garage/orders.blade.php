                    ...
                    <div class="box-filter-collapse">
                        ...
                        <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/orders')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <label class="col-md-3 control-label">{{__('cp.payment_type')}}</label>
                                        <div class="col-md-9">
                                            <select id="multiple2" class="form-control"
                                                    name="payment_type">
                                                <option value="">{{__('cp.all')}}</option>
                                                <option value="1">{{__('cp.electronic')}}</option>
                                                <option value="2">{{__('cp.points')}}</option>
                                                <option value="3">{{__('cp.Cash_on_delivery')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select id="multiple2" class="form-control"
                                                    name="type">
                                                <option value="">{{__('cp.all')}}</option>
                                                <option value="0">{{__('cp.normal')}}</option>
                                                <option value="1">{{__('cp.gift')}}</option>
